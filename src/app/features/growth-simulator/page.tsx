          ...
          <div className="grid items-center gap-8 lg:gap-16 lg:grid-cols-[0.9fr_1.1fr]">
            <div className="text-reveal">
              ...
              <motion.h1 {...fadeUp(0.08)} className="max-w-3xl text-3xl sm:text-4xl md:text-5xl 4xl:text-7xl font-black tracking-[-0.06em] text-slate-950">
                Test Growth <span className="text-[#09358c]">Before You Execute It.</span>
              </motion.h1>
              ...
              <motion.div {...fadeUp(0.24)} className="mt-10 flex flex-wrap items-center gap-6">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-xs font-black uppercase tracking-widest text-[#09358c]">Model paths instantly</span>
                </div>
              </motion.div>
            </div>

            <motion.div variants={revealVariant} initial="initial" whileInView="whileInView" viewport={{ once: true, amount: 0.3 }} className="rounded-[2rem] md:rounded-[4rem] border border-slate-200 bg-white p-6 md:p-7 shadow-[0_60px_150px_-70px_rgba(9,53,140,0.3)] relative overflow-hidden backdrop-blur-md">
              <div className="absolute top-0 right-0 w-80 h-80 bg-[#09358c]/5 blur-[100px] rounded-full pointer-events-none -translate-y-1/2 translate-x-1/2" />
              ...
              <div className="flex items-center justify-between rounded-4xl border border-[#09358c]/10 bg-[#09358c]/5 px-6 py-4 relative z-10 transition-colors hover:bg-[#09358c]/10">
                <div>
                  <p className="text-[10px] font-black uppercase tracking-[0.25em] text-[#09358c]">Growth scenario planner</p>
              ...
              <div className="mt-8 grid gap-10 lg:grid-cols-[0.9fr_1.1fr] relative z-10">
                <motion.div variants={staggerContainer} initial="initial" whileInView="whileInView" className="space-y-7">
                  {[
                    ...
                    <div key={item.label} className="group/slider">
                      <div className="mb-3 flex items-center justify-between text-xs font-black text-slate-500 uppercase tracking-[0.2em] group-hover/slider:text-[#09358c] transition-colors">
                      ...
                      <div className="relative h-3 rounded-full bg-slate-50 shadow-inner overflow-hidden border border-slate-100">
                        <motion.div 
                          ...
                          className="h-full rounded-full bg-gradient-to-r from-[#09358c] to-[#05a0ec]" 
                        />
                      </div>
                    </div>
                  ))}
                ...
                <motion.div initial={{ x: 20, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} transition={{ delay: 0.8 }} className="luminous-card-dark soft-shine rounded-[2.5rem] bg-slate-950 p-8 text-white shadow-[0_45px_120px_-60px_rgba(9,53,140,0.4)] relative overflow-hidden group/panel">
                  ...
                  <div className="mt-8 h-2.5 rounded-full bg-white/10 overflow-hidden shadow-inner">
                    <motion.div initial={{ width: 0 }} whileInView={{ width: "72%" }} transition={{ duration: 1.5, delay: 1.4, ease: "circOut" }} className="h-full rounded-full bg-gradient-to-r from-emerald-400 via-[#09358c] to-[#05a0ec]" />
                  </div>
                  
                  <div className="mt-8 grid grid-cols-2 gap-4">
                    {[
                      { label: "Growth prob", value: "84%", icon: TrendingUp, tone: "text-emerald-400" },
                      { label: "Exec risk", value: "Low", icon: CheckCircle2, tone: "text-[#05a0ec]" }
                    ].map((item, index) => (
      ...
      <section className="py-16 4xl:py-24 relative overflow-hidden font-inter">
        ...
        <Container>
          ...
          <div className="grid gap-12 lg:grid-cols-[0.8fr_1.2fr] items-center">
            ...
            <motion.div variants={revealVariant} initial="initial" whileInView="whileInView" viewport={{ once: true, amount: 0.14 }} className="rounded-[2rem] md:rounded-[3.5rem] border border-[#09358c]/10 bg-gradient-to-br from-white via-[#09358c]/5 to-[#05a0ec]/5 p-10 lg:p-14 relative backdrop-blur-sm shadow-inner group overflow-hidden">
              ...
              <motion.div initial={{ y: 20, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ delay: 0.7 }} className="mt-8 rounded-[2.5rem] border border-slate-100 bg-white p-8 relative z-10 shadow-sm hover:shadow-md transition-shadow cursor-default">
                 ...
                 <div className="mt-7 space-y-4">
                   {[
                     ...
                     ["Stability & Category push", "Predictable growth, low operating stress path", "text-[#09358c]"]
                   ].map(([title, note, tone], idx) => (
                     <motion.div key={title} whileHover={{ x: 8 }} transition={{ duration: 0.2 }} className="rounded-4xl bg-slate-50 px-6 py-5 border border-transparent hover:border-[#09358c]/20 hover:bg-white transition-all">
