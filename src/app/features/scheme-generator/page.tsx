...
export default function SchemeGeneratorPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-white pt-24 text-slate-900 selection:bg-blue-100 selection:text-blue-900 font-inter">
      <InteractiveGrid />
      <div className="pointer-events-none absolute inset-x-0 top-0 h-[400px] lg:h-[520px] bg-[radial-gradient(circle_at_top_right,rgba(59,130,246,0.14),transparent_36%),radial-gradient(circle_at_top_left,rgba(6,220,195,0.08),transparent_24%)]" />

      <section className="relative py-8 4xl:py-28">
        <Container>
          <div className="grid items-center gap-8 lg:gap-16 lg:grid-cols-[0.92fr_1.08fr]">
            <div className="text-reveal">
              <motion.div {...fadeUp()} className="mb-6 inline-flex items-center gap-2 rounded-full border border-blue-200 bg-blue-50 px-4 py-2 text-xs font-black uppercase tracking-[0.22em] text-blue-700 shadow-sm">
              ...
              <motion.div {...fadeUp(0.24)} className="mt-10 flex flex-wrap items-center gap-4">
                <Link href="/enterprise" className="group inline-flex items-center gap-3 rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 px-8 py-4 text-base font-black text-white shadow-[0_22px_60px_-18px_rgba(59,130,246,0.55)] transition-all hover:scale-[1.05] hover:shadow-[0_25px_70px_-15px_rgba(59,130,246,0.65)]">
            ...
            <motion.div variants={revealVariant} initial="initial" whileInView="whileInView" viewport={{ once: true, amount: 0.3 }} className="rounded-[2.5rem] md:rounded-[3.5rem] border border-slate-200 bg-white p-6 md:p-7 shadow-[0_50px_140px_-70px_rgba(59,130,246,0.5)] relative overflow-hidden backdrop-blur-md">
              <div className="absolute top-0 left-0 w-64 h-64 bg-cyan-100/30 blur-[100px] rounded-full pointer-events-none -translate-y-1/2 -translate-x-1/2" />
              
              <div className="flex items-center justify-between rounded-4xl border border-blue-100 bg-blue-50 px-6 py-4 relative z-10 transition-colors hover:bg-blue-100/50">
                <div>
                  <p className="text-[10px] font-black uppercase tracking-[0.25em] text-blue-600">Dynamic offer simulator</p>
              ...
              <div className="mt-8 space-y-7 relative z-10 px-2 lg:px-4">
                {[
                  ...
                  <div key={item.label} className="group/slider">
                    <div className="mb-3 flex items-center justify-between text-xs font-black text-slate-500 uppercase tracking-widest group-hover/slider:text-blue-600 transition-colors">
                    ...
                    <div className="relative h-3.5 rounded-full bg-slate-100 shadow-inner overflow-hidden">
                      <motion.div initial={{ width: 0 }} whileInView={{ width: item.width }} viewport={{ once: true }} transition={{ duration: 1.2, delay: 0.3 + index * 0.1, ease: [0.16, 1, 0.3, 1] }} className="h-full rounded-full bg-gradient-to-r from-blue-500 via-cyan-400 to-indigo-500 relative">
              ...
              <div className="mt-10 grid gap-6 md:grid-cols-2 relative z-10">
                <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} transition={{ delay: 0.8 }} className="rounded-[2rem] border border-blue-100 bg-white p-6 shadow-sm hover:shadow-md transition-shadow group/list">
                ...
                <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ delay: 1.2 }} className="luminous-card-dark soft-shine rounded-[2rem] bg-slate-950 p-6 text-white shadow-[0_30px_90px_-30px_rgba(15,23,42,0.9)] relative overflow-hidden group/winner">
                  ...
                  <p className="text-[10px] font-black uppercase tracking-[0.25em] text-blue-400">AI RECOMMENDED WINNER</p>
                  <p className="mt-4 text-3xl font-black text-white group-hover/winner:text-blue-300 transition-colors tracking-tight">Buy 2 Get 1</p>
      ...
      <section className="border-y border-slate-200 bg-slate-50/80 py-16 4xl:py-24">
        <Container>
          <motion.div variants={staggerContainer} initial="initial" whileInView="whileInView" viewport={{ once: true }} className="grid gap-6 lg:grid-cols-3">
            {[["Business problem", "Discounts often move stock at the expense of margin because teams cannot test enough scenarios before launch.", "text-rose-500"], ["What Tapito detects", "Tapito detects highest-yield structures by simulating depth, stock urgency, and behavior together.", "text-blue-600"], ["What action it enables", "Teams can deploy the offer most likely to clear inventory without sacrificing the bottom line.", "text-emerald-600"]].map(([title, text, tone], index) => (
            ...
            <motion.div variants={revealVariant} initial="initial" whileInView="whileInView" viewport={{ once: true, amount: 0.14 }} className="rounded-[2.5rem] md:rounded-[3.5rem] border border-blue-200 bg-gradient-to-br from-white via-blue-50/30 to-blue-50/50 p-10 lg:p-14 relative group shadow-inner">
               <div className="grid gap-6 md:grid-cols-3 relative z-10">
                {[
                  ...
                  <motion.div key={item.label} variants={fadeUp(0.2 + index * 0.1)} {...cardHover} className="luminous-card luminous-surface-strong rounded-[2.2rem] border border-blue-100 bg-white p-7 text-center group/card">
                    <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-4xl bg-blue-50 text-blue-600 group-hover/card:bg-blue-600 group-hover/card:text-white transition-all shadow-sm"><item.icon size={26} /></div>
              ...
              <motion.div initial={{ y: 20, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ delay: 0.6 }} className="mt-8 rounded-[2.5rem] border border-blue-100 bg-white p-8 relative z-10 shadow-sm group-hover:shadow-md transition-shadow cursor-default">
                 ...
                 <div className="mt-6 grid gap-4 md:grid-cols-2">
                    {[
                      { label: "Selected scheme", value: "Buy 2 Get 1 (BOGO)", theme: "bg-blue-50 text-blue-700" },
                      { label: "Margin status", value: "Within floor limits", theme: "bg-emerald-50 text-emerald-700" },
                      { label: "Stock velocity", value: "+18% projected", theme: "bg-blue-50 text-blue-700" },
      ...
      <section className="py-16 4xl:py-24 relative overflow-hidden font-inter">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full bg-[radial-gradient(circle,rgba(59,130,246,0.02),transparent_70%)] pointer-events-none" />
        <Container>
          ...
          <motion.div variants={staggerContainer} initial="initial" whileInView="whileInView" viewport={{ once: true }} className="grid gap-10 md:grid-cols-3">
            {[["+15%", "Margin preserved", "Average margin saved vs flat discounting"], ["+45%", "Stock clearance", "Increase in velocity for slow-moving categories"], ["-70%", "Planning time", "Consolidated simulation instead of manual Excel testing"]].map(([value, label, note], index) => (
              <motion.div key={label} {...fadeUp(index * 0.15)} {...cardHover} className="rounded-[2.5rem] md:rounded-[3rem] border border-slate-200 bg-white p-12 text-center group hover:bg-blue-50/30 transition-all shadow-sm">
                <motion.p animate={{ scale: [1, 1.08, 1] }} transition={{ duration: 3.5, repeat: Infinity }} className="text-6xl font-black tracking-tight text-blue-700 transition-transform group-hover:scale-110">{value}</motion.p>
        ...
        <Container>
          ...
          <div className="grid overflow-hidden rounded-[4rem] border border-slate-200 shadow-[0_50px_140px_-60px_rgba(15,23,42,0.4)] md:grid-cols-2 relative h-full">
            ...
            <motion.div initial={{ x: 100, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} viewport={{ once: true }} transition={{ duration: 1 }} className="bg-slate-950 p-12 lg:p-20 text-white relative h-full group">
              ...
              <p className="text-xs font-black uppercase tracking-[0.4em] text-blue-300 relative z-10">After Tapito Schemes</p>
