...
export default function SmartAnalyticsPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-white pt-24 text-slate-900 selection:bg-[#09358c]/10 selection:text-[#09358c]">
      <InteractiveGrid />
      <div className="pointer-events-none absolute inset-x-0 top-0 h-[400px] lg:h-[560px] bg-[radial-gradient(circle_at_top,rgba(9,53,140,0.14),transparent_38%),radial-gradient(circle_at_20%_20%,rgba(5,160,236,0.1),transparent_24%)]" />
      ...
      <section className="relative py-12 md:py-20 4xl:py-30">
        <Container>
          ...
          <motion.div variants={revealVariant} initial="initial" whileInView="whileInView" viewport={{ once: true, amount: 0.3 }} className="mx-auto mt-16 max-w-5xl rounded-[1.5rem] md:rounded-[2.5rem] border border-[#09358c]/10 bg-white/90 p-6 shadow-[0_45px_120px_-65px_rgba(9,53,140,0.3)] backdrop-blur lg:p-8">
            <div className="grid items-center gap-6 lg:grid-cols-[0.9fr_0.55fr_0.9fr]">
                ...
                {[
                  ...
                  <motion.div key={item.label} {...fadeUp(index * 0.1)} {...cardHover} className="luminous-card luminous-surface group rounded-[1.5rem] border border-slate-200 bg-slate-50 p-5">
                    <div className="flex items-center gap-4">
                      <motion.div whileHover={{ scale: 1.1, rotate: 5 }} className="flex h-12 w-12 items-center justify-center rounded-4xl bg-white text-[#09358c] shadow-sm transition-shadow group-hover:shadow-md transition-colors group-hover:bg-[#09358c]/5"><item.icon size={22} /></motion.div>
                      <div>
              ...
              <div className="relative flex min-h-[320px] items-center justify-center rounded-[2.5rem] bg-gradient-to-br from-[#09358c] via-[#09358c] to-[#05a0ec] p-6 text-white shadow-[0_30px_100px_-40px_rgba(9,53,140,0.5)]">
