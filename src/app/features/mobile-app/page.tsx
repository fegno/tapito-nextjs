          ...
          <div className="grid gap-10 lg:gap-20 lg:grid-cols-[0.92fr_1.08fr]">
            <div className="text-reveal">
              ...
              <motion.h1 {...fadeUp(0.08)} className="max-w-3xl text-3xl sm:text-4xl md:text-5xl 4xl:text-7xl font-black tracking-[-0.06em] text-slate-950">
                Your Business <span className="text-[#09358c]">Insights. Anywhere.</span>
              </motion.h1>
              ...
              <motion.div {...fadeUp(0.24)} className="mt-10 flex flex-wrap items-center gap-6">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-xs font-black uppercase tracking-widest text-[#09358c]">iOS & Android Natives</span>
                </div>
              </motion.div>
            </div>
              ...
              <motion.div whileHover={{ rotateY: -10, rotateX: 5 }} transition={{ duration: 0.6 }} className="relative max-w-[540px] rounded-[2rem] md:rounded-[3.5rem] border-[12px] border-slate-900 bg-slate-950 p-4 perspective-1000">
                <div className="overflow-hidden rounded-[2.5rem] bg-white h-full">
                  <div className="flex items-center justify-between border-b border-slate-100 bg-slate-50 px-6 py-6">
                    ...
                    <motion.div whileHover={{ scale: 1.1 }} className="flex h-10 w-10 items-center justify-center rounded-full bg-[#09358c] text-white font-black text-xs shadow-lg shadow-[#09358c]/30">JD</motion.div>
                  </div>
                  <div className="space-y-6 p-6">
                    ...
                    <motion.div initial={{ x: 30, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} transition={{ delay: 1.2, duration: 0.8, ease: "backOut" }} className="luminous-card-dark rounded-[1.75rem] bg-gradient-to-r from-[#09358c] to-[#05a0ec] p-6 text-white shadow-xl shadow-[#09358c]/20 relative group/alert">
                      <div className="flex items-center gap-3">
                        <motion.div animate={{ rotate: [0, 15, -15, 0] }} transition={{ duration: 0.5, repeat: Infinity, repeatDelay: 3 }}><Bell size={18} className="text-[#05a0ec]" /></motion.div>
                        <p className="text-[10px] font-black uppercase tracking-[0.22em] text-white/70">Push alert</p>
                      </div>
      ...
      <section className="border-y border-slate-200 bg-slate-50/80 py-16 4xl:py-24 px-4 font-inter">
        <Container>
          <motion.div variants={staggerContainer} initial="initial" whileInView="whileInView" viewport={{ once: true }} className="grid gap-6 lg:grid-cols-3">
            {[["Business problem", "When leaders leave the desk, they often lose real-time visibility into what is happening across stores.", "text-rose-500"], ["What Tapito detects", "Tapito detects critical store events, performance swings, and action-worthy alerts and pushes them instantly.", "text-[#09358c]"], ["What action it enables", "Managers stay decisive on the move with less lag between signal and response.", "text-emerald-600"]].map(([title, text, tone], index) => (
