export default function AnimatedBorderLargeSVG() {
  return (
    <svg
        ...
        >
          ...
          {/* Top Side Curves */}
          <g transform="translate(480, 40) rotate(0) scale(1.1, 0.9) translate(-160, 80)">
          ...
          {/* Bottom Side Curves */}
          <g transform="translate(480, 480) rotate(180) scale(1.1, 1) translate(-160, -49)">
            <g stroke="#05a0ec" strokeDasharray="0.1 5" strokeDashoffset="1" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2">
              <animate attributeName="stroke-dashoffset" values="0;5000" dur="300s" calcMode="linear" repeatCount="indefinite"></animate>
              <path d="M148 81V49a24 24 0 00-13.769-21.71l-13.051-6.15A16 16 0 01112 6.694V1"></path>
              <path d="M172 81V49a24 24 0 0113.769-21.71l13.051-6.15A16 16 0 00208 6.694V1"></path>
          ...
          {/* Left Side Curves */}
          <g transform="translate(222.626, 260) rotate(270) scale(1, 0.9) translate(-216, 56)">
            <g stroke="#05a0ec" strokeDasharray="0.1 5" strokeDashoffset="1" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2">
              <animate attributeName="stroke-dashoffset" values="0;5000" dur="300s" calcMode="linear" repeatCount="indefinite"></animate>
              <path d="M148 81V49a24 24 0 00-13.769-21.71l-13.051-6.15A16 16 0 01112 6.694V1"></path>
              <path d="M172 81V49a24 24 0 0113.769-21.71l13.051-6.15A16 16 0 00208 6.694V1"></path>
          ...
          {/* Right Side Curves */}
          <g transform="translate(737.374, 260) rotate(90) scale(1.2, 0.9) translate(-110, 56)">
            <g stroke="#05a0ec" strokeDasharray="0.1 5" strokeDashoffset="1" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2">
              <animate attributeName="stroke-dashoffset" values="0;5000" dur="300s" calcMode="linear" repeatCount="indefinite"></animate>
              <path d="M148 81V49a24 24 0 00-13.769-21.71l-13.051-6.15A16 16 0 01112 6.694V1"></path>
