            ...
            <div className="flex-1 p-8 relative overflow-hidden">
               <AnimatePresence mode="wait">
                  ...
                  >
                     ...
                     {/* Video Container with extra delay */}
                     <motion.div
                        initial={{ opacity: 0, scale: 0.98 }}
                        animate={{ opacity: 1, scale: 1 }}
                        transition={{ duration: 0.8, delay: 0.4 }}
                        className="relative w-full max-w-[480px] h-[320px] rounded-[8px] bg-slate-900 overflow-hidden shadow-2xl shadow-blue-900/10 border-4 border-white"
                     >
                        <video
                           key={`vid-${activeIndex}`}
                           autoPlay
